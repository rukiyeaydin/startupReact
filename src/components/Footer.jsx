  ...
  return (
    <div>
        <div className='p-4 w-full justify-center py-8  shadow-topShadow'>
            ...
            <hr className='border border-gray-250 mt-12 w-full lg:w-10/12 mx-auto' />
