...
import boyama from '../images/cards/boyama.jpg'
    ...
    <div className='px-4 py-20 flex flex-col lg:flex-row w-full lg:w-10/12 mx-auto'>
        <div className='w-full lg:w-96 mr-8'>
            <div className='bg-gray-100 p-4 mb-12 w-full'>
                <h2 className='font-bold text-2xl mb-4'>Yeniden İnşaat Boyama Hizmeti</h2>
                <div>
                    <ul>
        ...
        <div>
            <div>
                <img src={boyama} alt="" className='w-full h-auto rounded-lg' />
            </div>
            <div className='my-8'>
